                ...
                <div class="section-row sticky-container">
                    <div class="main-post">
                        ...
                        <figure class="figure-img">
                            <img class="img-responsive" src="{{ asset('uploads/'.$artikel_detail->gambar) }}" alt="" width="600"height="600">
                        </figure>
                       {!! $artikel_detail->body !!}
                    </div>
                    ...
                    <div class="category-widget">
                        <ul>
                            @foreach ($categori as $c)
                                <li><a href="{{ route('artikel.kategori',$c->slug) }}" class="cat-4">{{$c->name_katagori}}<span>
                                {{$c->artikel_count}}</span></a></li>
                            @endforeach
...
@push('categoris')
    <ul class="footer-links">
            @foreach ($categori as $item)
                <li><a href="#">{{$item->name_katagori}}</a></li>
